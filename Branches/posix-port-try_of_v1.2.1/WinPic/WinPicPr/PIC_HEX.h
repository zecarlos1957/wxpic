...
public:
  ...
  WORD   *pwFlags;  // points to "flags" (combination of PIC_BUFFER_FLAG_xxx)
  WORD   *pwFlagCopy; // points to copy of pwFlags for editing
...
int PicBuf_GetBufferByte(long i32TargetAddress, BYTE *pbDest); // always 8 bit, odd address allowed
...
/***************************************************************************/
void  PicBuf_SetConfigWord(int iCfgWordIndex, WORD wCfgWordValue);
