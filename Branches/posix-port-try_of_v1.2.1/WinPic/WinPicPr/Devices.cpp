...
wxString C_DEVLIST_FILE_NAME = wxT("devices.ini");
...
// sz40DeviceName, iCodeMemType, iBitsPerInstruction,  code mem size, data EEPROM size, internal RAM size,
    { wxT("PIC10F200"),     PIC_MT_FLASH, 12,                   256/*WORDS*/,  0,                16 ,
...
// sz40DeviceName, iCodeMemType, iBitsPerInstruction,  code mem size, data EEPROM size, internal RAM size,
    { wxT("PIC10F206"),     PIC_MT_FLASH, 12,                   512,           0,                24 ,
      // sz80ConfigRegisterInfoFile[] :
      wxT("PIC10F206.dev"),
      // lCodeMemWriteLatchSize, lCodeMemEraseLatchSize (only important for PIC18Fxxxx and dsPIC) :
      1, 1,
...
// sz40DeviceName, iCodeMemType, iBitsPerInstruction,  code mem size, data EEPROM size, internal RAM size,
    { wxT("PIC12F629"),     PIC_MT_FLASH, 14,                   1024,           128,             64 ,
      // sz80ConfigRegisterInfoFile[] :
      wxT("PIC12F629.dev"),
      // lCodeMemWriteLatchSize, lCodeMemEraseLatchSize (only important for PIC18Fxxxx and dsPIC) :
      1, 1,
...
// sz40DeviceName, iCodeMemType, iBitsPerInstruction, code mem size, data EEPROM size, internal RAM size,
    { wxT("PIC12F675"),     PIC_MT_FLASH, 14,                  1024,           128,             64 ,
      // sz80ConfigRegisterInfoFile[] :
      wxT("PIC12F675.dev"),
      // lCodeMemWriteLatchSize, lCodeMemEraseLatchSize (only important for PIC18Fxxxx and dsPIC) :
      1, 1,
...
// sz40DeviceName, iCodeMemType, iBitsPerInstruction, code mem size, data EEPROM size, internal RAM size,
    { wxT("PIC16C61"),      PIC_MT_EPROM, 14,                  1024,           0,               -1 ,
      // sz80ConfigRegisterInfoFile[] :
...
// sz40DeviceName, iCodeMemType, iBitsPerInstruction, code mem size, data EEPROM size, internal RAM size,
    { wxT("PIC16C71"), PIC_MT_EPROM,      14,                  1024,             0,         -1 ,
      // sz80ConfigRegisterInfoFile[] :
      wxT("PIC16C71.dev"),
      // lCodeMemWriteLatchSize, lCodeMemEraseLatchSize (only important for PIC18Fxxxx and dsPIC) :
      1, 1,
...
// sz40DeviceName, iCodeMemType, iBitsPerInstruction,  code mem size, data EEPROM size, internal RAM size,
    { wxT("PIC16C84"), PIC_MT_FLASH,      14,                   1024,            64,         -1 ,
      // sz80ConfigRegisterInfoFile[] :
...
// sz40DeviceName, iCodeMemType, iBitsPerInstruction,  code mem size, data EEPROM size, internal RAM size,
    { wxT("PIC16C710"),     PIC_MT_EPROM, 14,                   512,           0,                64 ,
      // sz80ConfigRegisterInfoFile[] :
      wxT(""),
      // lCodeMemWriteLatchSize, lCodeMemEraseLatchSize (only important for PIC18Fxxxx and dsPIC) :
      1, 1,
...
// sz40DeviceName, iCodeMemType, iBitsPerInstruction, code mem size, data EEPROM size, internal RAM size,
    { wxT("PIC16C711"),     PIC_MT_EPROM, 14,                  1024,          0,                64 ,
      // sz80ConfigRegisterInfoFile[] :
      wxT(""),
      // lCodeMemWriteLatchSize, lCodeMemEraseLatchSize (only important for PIC18Fxxxx and dsPIC) :
      1, 1,
...
// > in programming.
// sz40DeviceName, iCodeMemType, iBitsPerInstruction, code mem size, data EEPROM size, internal RAM size,
    { wxT("PIC16C715"),     PIC_MT_EPROM, 16/*!*/,             2048,          0,                128 ,
      // sz80ConfigRegisterInfoFile[] :
      wxT(""),
      // lCodeMemWriteLatchSize, lCodeMemEraseLatchSize (only important for PIC18Fxxxx and dsPIC) :
      1, 1,
...
// sz40DeviceName, iCodeMemType, iBitsPerInstruction, code mem size, data EEPROM size, internal RAM size,
    { wxT("PIC16F73"),      PIC_MT_FLASH, 14,                  4096,             0 ,            192 ,
      // sz80ConfigRegisterInfoFile[] :
      wxT("PIC16F73.dev"),
      // lCodeMemWriteLatchSize, lCodeMemEraseLatchSize (only important for PIC18Fxxxx and dsPIC) :
      1, 1,
...
// sz40DeviceName, iCodeMemType, iBitsPerInstruction, code mem size, data EEPROM size, internal RAM size,
    { wxT("PIC16F737"),     PIC_MT_FLASH, 14,                  4096,             0 ,            368 ,
      // sz80ConfigRegisterInfoFile[] :
      wxT("PIC16F737.dev"),
      // lCodeMemWriteLatchSize, lCodeMemEraseLatchSize (only important for PIC18Fxxxx and dsPIC) :
      1, 1,
...
// sz40DeviceName, iCodeMemType, iBitsPerInstruction, code mem size, data EEPROM size, internal RAM size,
    { wxT("PIC16F74"),      PIC_MT_FLASH, 14,                  4096,          0 ,               192 ,
      // sz80ConfigRegisterInfoFile[] :
      wxT("PIC16F74.dev"),
      // lCodeMemWriteLatchSize, lCodeMemEraseLatchSize (only important for PIC18Fxxxx and dsPIC) :
      1, 1,
...
// sz40DeviceName, iCodeMemType, iBitsPerInstruction, code mem size, data EEPROM size, internal RAM size,
    { wxT("PIC16F76"),      PIC_MT_FLASH, 14,                  8192,             0 ,            368 ,
      // sz80ConfigRegisterInfoFile[] :
      wxT("PIC16F76.dev"),
      // lCodeMemWriteLatchSize, lCodeMemEraseLatchSize (only important for PIC18Fxxxx and dsPIC) :
      1, 1,
...
// sz40DeviceName, iCodeMemType, iBitsPerInstruction, code mem size, data EEPROM size, internal RAM size,
    { wxT("PIC16F77"),      PIC_MT_FLASH, 14,                  8192,           0 ,              368 ,
      // sz80ConfigRegisterInfoFile[] :
      wxT("PIC16F77.dev"),
      // lCodeMemWriteLatchSize, lCodeMemEraseLatchSize (only important for PIC18Fxxxx and dsPIC) :
      1, 1,
...
// sz40DeviceName, iCodeMemType, iBitsPerInstruction, code mem size, data EEPROM size, internal RAM size,
    { wxT("PIC16F84"), PIC_MT_FLASH,      14,                  1024,          64,               64,
      // sz80ConfigRegisterInfoFile[] :
      wxT("PIC16F84.dev"),
      // lCodeMemWriteLatchSize, lCodeMemEraseLatchSize (only important for PIC18Fxxxx and dsPIC) :
      1, 1,
...
// sz40DeviceName, iCodeMemType, iBitsPerInstruction, code mem size, data EEPROM size, internal RAM size,
    { wxT("PIC16F627"),     PIC_MT_FLASH, 14,                  1024,          128,              224 ,
      // sz80ConfigRegisterInfoFile[] :
      wxT("PIC16F627.dev"),
      // lCodeMemWriteLatchSize, lCodeMemEraseLatchSize (only important for PIC18Fxxxx and dsPIC) :
      1, 1,
...
// sz40DeviceName, iCodeMemType, iBitsPerInstruction, code mem size, data EEPROM size, internal RAM size,
    { wxT("PIC16F628"),     PIC_MT_FLASH, 14,                  2048,           128,             224 ,
      // sz80ConfigRegisterInfoFile[] :
      wxT("PIC16F628.dev"),
      // lCodeMemWriteLatchSize, lCodeMemEraseLatchSize (only important for PIC18Fxxxx and dsPIC) :
      1, 1,
...
// sz40DeviceName, iCodeMemType, iBitsPerInstruction, code mem size, data EEPROM size, internal RAM size,
    { wxT("PIC16F630"),     PIC_MT_FLASH, 14,                  1024,           128,             64 ,
      // sz80ConfigRegisterInfoFile[] :
      wxT("PIC16F630.dev"),
      // lCodeMemWriteLatchSize, lCodeMemEraseLatchSize (only important for PIC18Fxxxx and dsPIC) :
      1, 1,
...
// sz40DeviceName, iCodeMemType, iBitsPerInstruction, code mem size, data EEPROM size, internal RAM size,
    { wxT("PIC16F818"),     PIC_MT_FLASH, 14,                  1024,          128 ,             128 ,
      // sz80ConfigRegisterInfoFile[] :
      wxT("PIC16F818.dev"),
      // lCodeMemWriteLatchSize, lCodeMemEraseLatchSize (only important for PIC18Fxxxx and dsPIC) :
      1, 1,
...
// sz40DeviceName, iCodeMemType,  iBitsPerInstruction, code mem size, data EEPROM size, internal RAM size,
    { wxT("PIC16F819"),     PIC_MT_FLASH,  14,                  2048,          256 ,             128 ,
      // sz80ConfigRegisterInfoFile[] :
      wxT("PIC16F819.dev"),
      // lCodeMemWriteLatchSize, lCodeMemEraseLatchSize (only important for PIC18Fxxxx and dsPIC) :
      1, 1,
...
// sz40DeviceName, iCodeMemType, iBitsPerInstruction, code mem size, data EEPROM size, internal RAM size,
    { wxT("PIC16F870"), PIC_MT_FLASH,     14,                  2048,            64 ,        -1  ,
      // sz80ConfigRegisterInfoFile[] :
      wxT("PIC16F870.dev"),
      // lCodeMemWriteLatchSize, lCodeMemEraseLatchSize (only important for PIC18Fxxxx and dsPIC) :
      1, 1,
...
// sz40DeviceName, iCodeMemType, iBitsPerInstruction, code mem size, data EEPROM size, internal RAM size,
    { wxT("PIC16F871"), PIC_MT_FLASH,     14,                  2048,            64 ,        -1  ,
      // sz80ConfigRegisterInfoFile[] :
      wxT("PIC16F871.dev"),
      // lCodeMemWriteLatchSize, lCodeMemEraseLatchSize (only important for PIC18Fxxxx and dsPIC) :
      1, 1,
...
// sz40DeviceName, iCodeMemType, iBitsPerInstruction,  code mem size, data EEPROM size, internal RAM size,
    { wxT("PIC16F872"),     PIC_MT_FLASH, 14                 ,  2048,            64 ,        -1 ,
      // sz80ConfigRegisterInfoFile[] :
      wxT("PIC16F872.dev"),
      // lCodeMemWriteLatchSize, lCodeMemEraseLatchSize (only important for PIC18Fxxxx and dsPIC) :
      1, 1,
...
// sz40DeviceName, iCodeMemType, iBitsPerInstruction,  code mem size, data EEPROM size, internal RAM size,
    { wxT("PIC16F873"), PIC_MT_FLASH,     14,                   4096,            128,        -1 ,
      // sz80ConfigRegisterInfoFile[] :
      wxT("PIC16F873.dev"),
      // lCodeMemWriteLatchSize, lCodeMemEraseLatchSize (only important for PIC18Fxxxx and dsPIC) :
      1, 1,
...
// sz40DeviceName, iCodeMemType, iBitsPerInstruction, code mem size, data EEPROM size, internal RAM size,
    { wxT("PIC16F874"), PIC_MT_FLASH,     14,                  4096,            128,        -1 ,
      // sz80ConfigRegisterInfoFile[] :
      wxT("PIC16F874.dev"),
      // lCodeMemWriteLatchSize, lCodeMemEraseLatchSize (only important for PIC18Fxxxx and dsPIC) :
      1, 1,
...
// sz40DeviceName, iCodeMemType, iBitsPerInstruction, code mem size, data EEPROM size, internal RAM size,
    { wxT("PIC16F876"),     PIC_MT_FLASH, 14,                  8192,            256,        -1 ,
      // sz80ConfigRegisterInfoFile[] :
      wxT("PIC16F876.dev"),
      // lCodeMemWriteLatchSize, lCodeMemEraseLatchSize (only important for PIC18Fxxxx and dsPIC) :
      1, 1,
...
// sz40DeviceName, iCodeMemType, iBitsPerInstruction, code mem size, data EEPROM size, internal RAM size,
    { wxT("PIC16F877"), PIC_MT_FLASH,     14,                  8192,            256,        -1 ,
      // sz80ConfigRegisterInfoFile[] :
      wxT("PIC16F877.dev"),
      // lCodeMemWriteLatchSize, lCodeMemEraseLatchSize (only important for PIC18Fxxxx and dsPIC) :
      1, 1,
...
// sz40DeviceName, iCodeMemType, iBitsPerInstruction, code mem size, data EEPROM size, internal RAM size,
    { wxT("PIC18F252"),     PIC_MT_FLASH, 16/*!*/,             16384/*instr!*/,  256/*byte!*/,  1536/*byte!*/,
      // sz80ConfigRegisterInfoFile[] :
...
// sz40DeviceName, iCodeMemType, iBitsPerInstruction, code mem size, data EEPROM size, internal RAM size,
    { wxT("PIC18F2550"),    PIC_MT_FLASH, 16/*!*/,             16384/*instr!*/,  256/*byte!*/,  2048/*byte!*/,
      // sz80ConfigRegisterInfoFile[] :
...
// sz40DeviceName, iCodeMemType, iBitsPerInstruction, code mem size, data EEPROM size, internal RAM size,
    { wxT("PIC18F4455"),    PIC_MT_FLASH, 16/*!*/,             12288/*instr!*/,  256/*byte!*/,  2048/*byte!*/,
      // sz80ConfigRegisterInfoFile[] :
...
// sz40DeviceName, iCodeMemType, iBitsPerInstruction, code mem size, data EEPROM size, internal RAM size,
    { wxT("PIC18F4550"),    PIC_MT_FLASH, 16/*!*/,             16384/*instr!*/,  256/*byte!*/,  2048/*byte!*/,
      // sz80ConfigRegisterInfoFile[] :
...
// sz40DeviceName, iCodeMemType, iBitsPerInstruction, code mem size, data EEPROM size, internal RAM size,
    { wxT("dsPIC30F2010"),  PIC_MT_FLASH, 24/*!*/,             4096/*instr!*/, 1024,            512,
      // sz80ConfigRegisterInfoFile[] :
...
// sz40DeviceName, iCodeMemType, iBitsPerInstruction, code mem size, data EEPROM size, internal RAM size,
    { wxT("dsPIC30F4013"),  PIC_MT_FLASH, 24/*!*/,             16384/*instr!*/, 1024,            512,
      // sz80ConfigRegisterInfoFile[] :
...
// sz40DeviceName, iCodeMemType, iBitsPerInstruction, code mem size, data EEPROM size, internal RAM size,
    { wxT("dsPIC30F6010"),  PIC_MT_FLASH, 24/*!*/,             49152/*instr!*/, 4096,            512,
      // sz80ConfigRegisterInfoFile[] :
...
// sz40DeviceName, iCodeMemType, iBitsPerInstruction,  code mem size, data EEPROM size, internal RAM size,
    { wxT("PIC??????"), PIC_MT_FLASH,       14,                   8192,          256,              -1 ,
      // sz80ConfigRegisterInfoFile[] :
...
/***************************************************************************/
wxString PicDev_AlgorithmCodeToString(int iAlgorithm)
{
    switch (iAlgorithm)
    {
    case PIC_ALGO_16FXX:
...
int PicDev_StringToAlgorithmCode(const char * pszAlgorithmName)
{
    ...
    if (strcmp(pszAlgorithmName, "16Fxx")==0)
        return PIC_ALGO_16FXX;
    if (strcmp(pszAlgorithmName, "16Fxx_OLD_ERASE")==0)
        return PIC_ALGO_16FXX_OLD_ERASE;
    if (strcmp(pszAlgorithmName, "12Fxx")==0)
        return PIC_ALGO_12FXX;
    if (strcmp(pszAlgorithmName, "16F630")==0)
        return PIC_ALGO_16F630;
    if (strcmp(pszAlgorithmName, "16F7x7")==0)
        return PIC_ALGO_16F7X7;
    if (strcmp(pszAlgorithmName, "16F7x")==0)
        return PIC_ALGO_PIC16F7X;
    if (strcmp(pszAlgorithmName, "16F716")==0)
        return PIC_ALGO_PIC16F716;

    if (strcmp(pszAlgorithmName, "16F81x")==0)
        return PIC_ALGO_16F81X;
    if (strcmp(pszAlgorithmName, "16F87xA")==0)
        return PIC_ALGO_16F87XA;
    if (strcmp(pszAlgorithmName, "16F87x")==0)
        return PIC_ALGO_16F87X;
    if (strcmp(pszAlgorithmName, "16Cxx")==0)
        return PIC_ALGO_16CXX;
    if (strcmp(pszAlgorithmName, "dsPIC30F")==0)
        return PIC_ALGO_dsPIC30F;
    if (strcmp(pszAlgorithmName, "PIC18F")==0)
        return PIC_ALGO_PIC18F;
    if (strcmp(pszAlgorithmName, "PIC18F_OLD")==0)
        return PIC_ALGO_PIC18F_OLD;
    if (strcmp(pszAlgorithmName, "PIC10F20x")==0)
        return PIC_ALGO_PIC10F;
    if (strcmp(pszAlgorithmName, "ERASE_16F62xA")==0)
        return PIC_ALGO_ERASE_16F62XA;
    if (strcmp(pszAlgorithmName, "ERASE_16F81x")==0)
        return PIC_ALGO_ERASE_16F81X;
    if (strcmp(pszAlgorithmName, "ERASE_16F87xA")==0)
        return PIC_ALGO_ERASE_16F87XA;
    if (strcmp(pszAlgorithmName, "ERASE_16F87x")==0)
        return PIC_ALGO_ERASE_16F87X;
    if (strcmp(pszAlgorithmName, "ERASE_12F6xx")==0)
        return PIC_ALGO_ERASE_12F6XX;

    if (strcmp(pszAlgorithmName, "DATA_EEPROM_16xxx")==0)
        return PIC_ALGO_DATA_EEPROM_16XXX;

    if (strcmp(pszAlgorithmName, "CONFIG_MEM_16xxx")==0)
        return PIC_ALGO_CONFIG_MEM_16XXX;

    if (strcmp(pszAlgorithmName, "CONFIG_MEM_16F81x")==0)
        return PIC_ALGO_CONFIG_MEM_16F81X;

    if (strcmp(pszAlgorithmName, "CONFIG_MEM_16F87xA")==0)
        return PIC_ALGO_CONFIG_MEM_16F87XA;

    if (strcmp(pszAlgorithmName, "MULTI_WORD")==0)
        return PIC_ALGO_MULTI_WORD;

    if (strcmp(pszAlgorithmName, "NONE")==0)
        return PIC_ALGO_UNKNOWN;

    sprintf(sz80Temp, "Unknown algorithm name : \"%hs\" !", pszAlgorithmName);
    APPL_ShowMsg( APPL_CALLER_PIC_PRG, 0, wxString::FromAscii(sz80Temp) );
    return  PIC_ALGO_UNKNOWN;
...
{
    if (strcmp(pszVppVddSequence, "Vdd_before_Vpp")==0)
        return PROGMODE_VDD_THEN_VPP;
    if (strcmp(pszVppVddSequence, "Vpp_before_Vdd")==0)
...
//---------------------------------------------------------------------------
wxString PicDev_VppVddSequenceCodeToString(int iVppVddSequence)
{
    switch ( iVppVddSequence )
    {
    case PROGMODE_VPP_THEN_VDD :
        return _("Vpp_before_Vdd");
    case PROGMODE_VDD_THEN_VPP :
        return _("Vdd_before_Vpp");
    default:
        return _("unknown");
    }
...
//   to avoid false verify-errors !
{
            ...
            && ( (long)(dwTargetAddress) <  PIC_DeviceInfo.lConfMemBase + PIC_DeviceInfo_iConfMemSize * PicDevInfo_i32ConfMemAddressFactor ) )
    {
        ...
        while ( pConfigBitInfo->szText && pConfigBitInfo->szText[0] ) // Check all entries in the config bit table..
        {
            ...
            if ( (PicDevInfo_i32ConfMemAddressFactor==2) // 2 for PIC18F ("words", but each uint8_t has its own address)
        ...
        {
            return 0x000000FFL;  // WinPic always treats DATA EEPROM as uint8_t-array !
        }
...
//---------------------------------------------------------------------------
wxString PicDev_GetInfoOnConfigMemory(uint32_t dwCfgMemAddress)
{
    if ( PIC_DeviceInfo.iBitsPerInstruction == 24 )
    {
...
//---------------------------------------------------------------------------
wxString PicDev_ConfigBitValueToString( T_PicConfigBitInfo *pConfigBitInfo, uint32_t dwConfigRegisterContent )
{
...
//---------------------------------------------------------------------------
bool PicDev_ConfigBitStringToValue( T_PicConfigBitInfo *pConfigBitInfo, wxString pszComboText, uint32_t *pdwDest )
{
    bool fResult=false;
    P_PicConfigBitSetting pBitCombiInfo;
...
//     fResult = false;
        fResult = pszComboText.ToLong((long int*)&dwValue);
    }
...
//---------------------------------------------------------------------------
wxString PicDev_GetDeviceFileName(void)
{
        ...
        while ( myQFile.QFile_ReadLine( sz255Line, 254 ) >= 0 )
        {
            ...
            if ( (sz255Line[0]!=';') && (pszValue!=NULL) )
            {
                *pszValue = '\0'; // terminate KEY-name (overwrite '=')
                ...
                {
                    pDevInfo->sz40DeviceName.FromAscii( pszValue );
                }
                ...
                {
                    pDevInfo->sz80ConfigRegisterInfoFile = wxString::FromAscii( pszValue );
//                strncpy(pDevInfo->sz80ConfigRegisterInfoFile, pszValue, 80);
                }
                ...
                {
                    pDevInfo->wCanRead =(WORD)i32Value;
                }
...
WORD PicDev_wCfgBitInfoCount;     // counts "cfgbits" "field"    definitions
WORD PicDev_wCfgBitInfoIndex;     // current index into PicDev_ConfigBitInfo[]
WORD PicDev_wCfgBitSettingCount;  // counts "cfgbits" "setting"  definitions
WORD PicDev_wCfgBitSettingIndex;  // current index into PicDev_CfgBitSettings[]
WORD PicDev_wNrOfSettingsInField; // number of "bit settings" in the current "field"
...
//              sz60Text[10] = 0;
                ...
                pBitGroupInfo->szText = wxString::FromAscii(sz60Text);
            ...
            if ( PicDev_SkipChar(&cp,'(') )
            {
                ...
                while ( (token=PicDev_ParseTokenAndAssignOp( McDev_ArglistSymbols,&cp)) != McDev_TOK_NONE)
                {
                    ...
                    case McDev_TOK_desc:  // description for THIS config bit combination
                        ...
                        pBitSetting->szComboText = wxString::FromAscii(sz60Text);
                        break;
...
/***************************************************************************/
bool PicDev_LoadMcDevFile( wxString pszDevFileName )
...
//    char sz355DevFileName[356];
    ...
    {
        if (PicDev_ConfigBitInfo[i].szText != wxT(""))
        {
            PicDev_ConfigBitInfo[i].szText = wxT("");
        }
    }
         ...
         if (psrcPicDeviceInfo->sz80ConfigRegisterInfoFile.AfterLast('.') == wxT(".dev"))
            {
                ...
                table_loaded = PicDev_LoadMcDevFile(DevFilenameText);
            }
    ...
    if ( ! table_loaded )
    {
        if ( psrcPicDeviceInfo->lConfWordAdr == 0x002007 )
        {
            ...
            for (i=0;i<PICDEV_MAX_CONFIG_BIT_INFOS;++i)
            {
                ...
                if ( BuiltInConfigBitInfo_PIC16F[i].szText == wxT("") )
                    break;
            }
        }
        else if ( psrcPicDeviceInfo->lConfWordAdr == 0x0F80000 )
        {
            ...
            for (i=0;i<PICDEV_MAX_CONFIG_BIT_INFOS;++i)
            {
                ...
                if ( BuiltInConfigBitInfo_dsPIC30F[i].szText == wxT("") )
                    break;
            }
        }
...
// returns a table index (0..n) if successfull, negative value otherwise
{
    ...
    for (i=0; i<iCountOfBuiltInDevices; ++i)
    {
        ...
        if ( BuiltInPicDeviceInfo[i].sz40DeviceName == wxString::FromAscii( pszDeviceName ))
        {
...
/***************************************************************************/
wxString PicDev_GetDeviceNameByIdWord( WORD wDeviceIdWord, int iBitsPerInstruction )
...
// the "core family" (=number of bits per instruction word; 14,16,24, ..).
{
    ...
    if (   wDeviceIdWord==0x0000
        ...
        return wxT("");    // not "unknown" but "nothing read"
...
{
    wxString Buf = wxString::Format(wxT("%i"),Value);
    File.Write (Key, strlen(Key));
    File.Write ("=", 1);
    File.Write (Buf);
    File.Write ("\n", 1);
...
//---------------------------------------------------------------------------
void PicDev_DumpDeviceListToFile( const char *pszDumpFileName )
{
// originally just a "test function" but may be interesting for the user..
    ...
    DumpFilename.SetFullName(wxString::FromAscii(pszDumpFileName));
    ...
    for (i=0; PicDev_GetBuiltInDeviceInfoByIndex( i/*iTableIndex*/, &MyDeviceInfo ) >= 0; ++i)
    {
        char sz7[8];
        sprintf(sz7, "dev%d", i);
        WriteValue(IniFile, sz7, MyDeviceInfo.sz40DeviceName.To8BitData());
    }


    for (i=0; PicDev_GetBuiltInDeviceInfoByIndex( i/*iTableIndex*/, &MyDeviceInfo ) >= 0; ++i)
    {
        WriteHeader(IniFile, MyDeviceInfo.sz40DeviceName.To8BitData());                 // produce an index of all devices
        WriteValue(IniFile,"DeviceName",MyDeviceInfo.sz40DeviceName.To8BitData());
        ...
        WriteValue(IniFile,"EraseAlgo",     PicDev_AlgorithmCodeToString(MyDeviceInfo.wEraseAlgo).To8BitData() );
        WriteValue(IniFile,"CodeProgAlgo",  PicDev_AlgorithmCodeToString(MyDeviceInfo.wCodeProgAlgo).To8BitData() );
        WriteValue(IniFile,"ConfigProgAlgo",PicDev_AlgorithmCodeToString(MyDeviceInfo.wConfigProgAlgo).To8BitData() );
        WriteValue(IniFile,"DataProgAlgo",  PicDev_AlgorithmCodeToString(MyDeviceInfo.wDataProgAlgo).To8BitData() );

        WriteValue(IniFile,"VppVddSequence",PicDev_VppVddSequenceCodeToString(MyDeviceInfo.wVppVddSequence).To8BitData() );
