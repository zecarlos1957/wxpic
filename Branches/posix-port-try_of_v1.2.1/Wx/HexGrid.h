...
public:
    ...
    void LoadHexData (unsigned long *pHexData, int pLength, TAddressGetter &pAddressGetter, wxString pTitle=wxEmptyString, unsigned pSecond = 0);
    void UnloadData  (unsigned pSecond) { LoadHexData(NULL, 0, *(TAddressGetter*)NULL, wxEmptyString, pSecond); }
