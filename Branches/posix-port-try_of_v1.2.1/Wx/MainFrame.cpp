...
//void MainFrame::ClearFusesClick(TObject *Sender)
{
    ...
    if ( CommandOption.WinPic_i32CmdLineOption_OverrideConfigWord >= 0)
        PicBuf_SetConfigWord( 0, (WORD)CommandOption.WinPic_i32CmdLineOption_OverrideConfigWord );
    else
...
//void MainFrame::FormKeyDown(TObject *Sender, WORD &Key,
//      TShiftState Shift)
{
...
////---------------------------------------------------------------------------
//void MainFrame::HexEditKeyDown(TObject *Sender, WORD &Key,
//      TShiftState Shift)
//{
