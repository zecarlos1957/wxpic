...
public:
    ...
    //-- Charge la table
    void LoadHexData (unsigned long *pHexData, int pLength, THexGrid::TAddressGetter &pAddressGetter, wxString pTitle, unsigned pSecond)
    {
        wxASSERT(pSecond<2);
    ...
    virtual void SetValue( int row, int col, const wxString& value )
    {
        ...
        *Dst = 0;
        ...
        unsigned long MemValue = _tcstol(Buffer, &Dst, 16);
        unsigned long &EditedWord = aHexData[Second][MemAddr];
...
void THexGrid::LoadHexData (unsigned long *pHexData, int pLength, TAddressGetter &pAddressGetter, wxString pTitle, unsigned pSecond)
{
