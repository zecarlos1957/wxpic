...
//   int  digit;
    ...
    else if (pszSource[0]=='0' && (pszSource[1]=='x' || pszSource[1]=='X') )
    {
        hex=1;    /* Hex-Zahl im "C"-Stil */
        pszSource+=2;
    }
    else if (*pszSource=='#')
    {
 ...
 */
{
    ...
    case 12:
        dw = 0x00FFF;
        break;  // stoneage PICs  ("12 bit core")
    case 14:
        dw = 0x03FFF;
        break;  // 12Fxxx, 16Fxxx ("14 bit core")
    case 16:
        dw = 0x0FFFF;
        break;  // 18Fxxx         ("16 bit core")
    case 24:
        dw = 0x00FFFFFF;
        break;  // dsPIC30F ("enhanced 16 bit core")
    default:
        dw = 0x03FFF;
        break;
    }
